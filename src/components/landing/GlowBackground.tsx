...
export function GlowBackground({ className }: GlowBackgroundProps) {
  return (
    ...
    >
      ...
      <div
        className="absolute top-20 left-10 w-[420px] h-[420px] opacity-40"
        style={{
          background:
      ...
      <div
        className="absolute top-40 right-20 w-[520px] h-[520px] opacity-35"
        style={{
          background:
      ...
      <div
        className="absolute bottom-32 left-1/4 w-[460px] h-[460px] opacity-30"
        style={{
          background:
      ...
      <div
        className="absolute bottom-20 right-1/3 w-[400px] h-[400px] opacity-25"
        style={{
          background:
      ...
      <div
        className="absolute top-1/3 left-1/3 w-[340px] h-[340px] opacity-20"
        style={{
          background:
      ...
      <div
        className="absolute top-0 left-1/4 w-[900px] h-[900px] rounded-full opacity-15 animate-glow-pulse"
        style={{
          background:
